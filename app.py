...
with tab1:
    ...
    if MATERIAL_PRICES:
        # ยุบรวมทั้งหมายเหตุเตือนและตารางราคาให้อยู่ในกล่องเดียวกัน เพื่อความกระชับและสแกนสายตาง่าย
        with st.expander("📦 รายการวัสดุอุปกรณ์และราคากลาง (สำหรับวางแผนคำนวณต้นทุน)", expanded=True):
            st.warning("""
**⚠️ หมายเหตุสำคัญในการดำเนินโครงการ:**
* \* **ห้ามเปลี่ยนสภาพเดิม** ของวัสดุอุปกรณ์หลักที่กำหนดไว้ในเงื่อนไขการส่งมอบ
* \*\* **เสียบได้เฉพาะไม้เสียบลูกชิ้น** เท่านั้น ห้ามใช้วัสดุแหลมคมหรือสิ่งอื่นนอกเหนือจากที่ระบุ
""")
